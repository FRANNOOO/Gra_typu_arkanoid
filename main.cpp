...
bool wszystkieBlokiZniszczone(const std::vector<Stone>& bloki)
{
...
int main() {
    ...
    Paletka pal(520.f, 440.f, 100.f, 20.f, 8.f); // x,y,szer,wys, predkosc
    Pilka pilka(320.f, 300.f, 4.f, 3.f, 8.f); // x,y,vx,vy,radius
    ...
    while (window.isOpen()) {
        ...
        if (wszystkieBlokiZniszczone(bloki)) {
